  ...
  return (
    <div className="w-full">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link href="/requests/create" className="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600">
          + New Request
        </Link>
      </div>
      ...
      {requests.length === 0 ? (
        <div className="text-center py-12 bg-white rounded-xl border border-gray-100 shadow-sm">
          ...
          <Link href="/requests/create" className="text-primary font-bold hover:underline">Request Help Now</Link>
        </div>
      ) : (
