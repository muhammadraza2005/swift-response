...
export default function ContactPage() {
  ...
  const heroCards = [
    { title: 'We are always here to listen to you', icon: Ear },
    { title: 'Quick responses to your queries', icon: Zap },
    { title: 'Multiple ways to reach us', icon: Phone }
  ];
                  ...
                  <div className="glass p-6 rounded-2xl">
                    ...
                    <div className="flex gap-4">
                      <a
                        ...
                        className="w-12 h-12 bg-white rounded-lg flex items-center justify-center hover:scale-110 transition-transform shadow-md text-[#1877F2]"
                        aria-label="Facebook"
                      >
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-12 h-12 bg-white rounded-lg flex items-center justify-center hover:scale-110 transition-transform shadow-md text-[#0A66C2]"
                        aria-label="LinkedIn"
                      >
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-12 h-12 bg-white rounded-lg flex items-center justify-center hover:scale-110 transition-transform shadow-md text-[#E4405F]"
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-12 h-12 bg-white rounded-lg flex items-center justify-center hover:scale-110 transition-transform shadow-md text-black"
