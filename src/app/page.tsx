    ...
    <div className="flex flex-col bg-white">
      ...
      <section className="relative bg-gradient-to-br from-[#008C5A] to-[#006B47] text-white overflow-hidden pt-8">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl relative z-10 text-center py-24 sm:py-32 lg:py-40">
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-6 leading-tight animate-fade-in-up tracking-tight">
            Swift Response
          </h1>
          <p className="text-xl sm:text-2xl md:text-3xl mb-12 opacity-95 animate-fade-in-up max-w-3xl mx-auto px-4 font-light" style={{ animationDelay: '100ms' }}>
