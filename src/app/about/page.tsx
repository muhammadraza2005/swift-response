export default function AboutPage() {
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="relative relative min-h-screen flex items-center justify-center bg-gradient-to-br from-[#008C5A] to-[#006B47] text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center py-16 sm:py-20">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 animate-fade-in-up">About Swift Response</h1>
      ...
      <div className="max-w-6xl mx-auto py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
        ...
        <section className="min-h-screen flex items-center justify-center py-16 sm:py-20">
          <div className="w-full">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#333333] mb-6 text-center">Our Mission</h2>
            <div className="glass p-6 sm:p-8 md:p-10 rounded-3xl max-w-4xl mx-auto">
        ...
        <section className="min-h-screen flex items-center justify-center py-16 sm:py-20">
          <div className="w-full">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#333333] mb-6 text-center">Our Vision</h2>
            <div className="glass p-6 sm:p-8 md:p-10 rounded-3xl max-w-4xl mx-auto">
              <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed text-center">
        ...
        <section className="min-h-screen flex items-center justify-center py-16 sm:py-20">
          <div className="w-full">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#333333] mb-8 sm:mb-12 text-center">Our Values</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div 
                key={value.title}
                className="glass p-6 sm:p-8 rounded-2xl hover:-translate-y-2 transition-all duration-300 group active:scale-95 cursor-pointer"
                style={{animationDelay: `${index * 100}ms`}}
              >
                <div className="text-4xl sm:text-5xl mb-4 group-hover:scale-125 transition-transform duration-300">
                  {value.icon}
                </div>
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-[#333333] mb-3 group-hover:text-[#008C5A] transition-colors">
                  {value.title}
                </h3>
        ...
        <section className="min-h-screen flex items-center justify-center py-16 sm:py-20">
          <div className="w-full">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#333333] mb-8 sm:mb-12 text-center">Who We Serve</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
            {[
              ...
              <div 
                key={audience.title}
                className="bg-gradient-to-br from-white to-[#F8F9FA] p-6 sm:p-8 rounded-2xl border-2 border-[#E9ECEF] hover:border-[#008C5A] hover:shadow-xl transition-all duration-300 active:scale-95 cursor-pointer"
                style={{animationDelay: `${index * 100}ms`}}
              >
                <div className="text-3xl sm:text-4xl mb-4">{audience.icon}</div>
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-[#333333] mb-3">{audience.title}</h3>
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">{audience.description}</p>
              </div>
            ))}
          </div>
          </div>
        ...
        <section className="min-h-screen flex items-center justify-center py-16 sm:py-20">
          <div className="w-full">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#333333] mb-8 sm:mb-12 text-center">Our Team</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div 
                key={member.name}
                className="glass p-6 sm:p-8 rounded-2xl text-center hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 group active:scale-95 cursor-pointer"
                style={{animationDelay: `${index * 100}ms`}}
              >
                <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-[#008C5A] to-[#00A366] rounded-full mx-auto mb-4 sm:mb-6 flex items-center justify-center text-white text-2xl sm:text-3xl font-bold group-hover:scale-110 transition-transform">
                  {member.name.split(' ').map(n => n[0]).join('')}
                </div>
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-[#333333] mb-2 group-hover:text-[#008C5A] transition-colors">
                  {member.name}
                </h3>
                <p className="text-[#FFD700] font-semibold mb-2 text-sm sm:text-base">{member.role}</p>
                <p className="text-gray-600 text-sm sm:text-base">{member.expertise}</p>
              </div>
            ))}
          </div>
          </div>
