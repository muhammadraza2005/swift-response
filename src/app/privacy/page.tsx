...
import { Lock, Shield, ClipboardList } from 'lucide-react';

export default function PrivacyPage() {
  const heroCards = [
    { title: 'Your data is secure', icon: Lock },
    { title: 'We respect your privacy', icon: Shield },
    { title: 'Transparent data handling', icon: ClipboardList }
  ];
